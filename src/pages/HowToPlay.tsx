...
const HowToPlay = () => {
  ...
  return (
    ...
    >
      <Card className="w-full max-w-4xl bg-card text-card-foreground dark:bg-card/40 dark:backdrop-blur-lg border dark:border-white/20 p-6 sm:p-8 rounded-2xl shadow-2xl text-center">
        ...
        <CardContent className="text-left space-y-4">
          ...
          <Button
            ...
            className="w-full bg-primary text-primary-foreground hover:bg-primary/90 dark:bg-white/30 dark:text-white dark:hover:bg-white/50 dark:backdrop-blur-lg text-base md:text-lg py-6 rounded-xl transition-all duration-300 ease-in-out transform hover:scale-105 mt-6 flex items-center justify-center gap-3 shadow-lg"
          >
