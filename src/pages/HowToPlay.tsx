...
const HowToPlay = () => {
  ...
  return (
    ...
    >
      <Card className="w-full max-w-4xl p-6 sm:p-8 rounded-3xl shadow-2xl text-card-foreground text-center border-border dark:bg-card dark:backdrop-blur-lg dark:border">
