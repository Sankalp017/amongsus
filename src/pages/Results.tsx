...
const Results = () => {
  ...
  return (
    <div
      className="min-h-screen w-full flex flex-col items-center justify-center bg-gradient-to-br from-blue-500 via-purple-500 to-yellow-500 dark:bg-gradient-to-br dark:from-slate-900 dark:via-indigo-950 dark:to-slate-900 text-white p-4 overflow-hidden"
    >
      <ReactConfetti
        ...
        <CardContent className="p-0">
          ...
          <div className="flex flex-col space-y-3 mt-8">
            <Button
              ...
              variant="outline"
              className="w-full bg-white/30 backdrop-blur-lg text-white hover:bg-white/50 shadow-lg text-base md:text-lg py-6 rounded-xl transition-all duration-300 ease-in-out transform hover:scale-105 flex items-center justify-center gap-2"
            >
            ...
            <Button
              ...
              variant="outline"
              className="w-full bg-white/20 backdrop-blur-lg text-white hover:bg-white/40 text-base md:text-lg py-6 rounded-xl transition-all duration-300 ease-in-out transform hover:scale-105 flex items-center justify-center gap-2"
            >
