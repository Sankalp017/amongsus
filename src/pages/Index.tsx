      ...
      <div className="flex flex-col items-center justify-center flex-grow text-center">
        ...
        <div className="flex flex-col space-y-4 w-full max-w-xs">
          ...
          <Button
            ...
            className="bg-white/20 backdrop-blur-lg text-white hover:bg-white/30 hover:text-white text-lg md:text-xl px-8 py-4 rounded-full shadow-xl transition-all duration-300 ease-in-out transform hover:scale-105"
          >
            How to Play
          </Button>
        </div>
