...
const NameReveal = () => {
  ...
  return (
    ...
    >
      <Card className="w-full max-w-md bg-card text-card-foreground dark:bg-card/40 dark:backdrop-blur-lg border dark:border-white/20 p-6 sm:p-8 rounded-2xl shadow-2xl text-center relative">
        {showTimer ? (
          ...
          <>
            ...
            <Button
              ...
              disabled={!showWord}
              className="w-full bg-primary text-primary-foreground hover:bg-primary/90 dark:bg-white/30 dark:text-white dark:hover:bg-white/50 dark:backdrop-blur-lg shadow-lg text-base md:text-lg py-4 rounded-xl transition-all duration-300 ease-in-out transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed dark:disabled:bg-white/10 dark:disabled:text-white/50"
            >
